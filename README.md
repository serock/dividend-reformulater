...
2. Verify the integrity of the downloaded archive (e.g., on Linux, run `sha256sum -c dividend-reformulater-2025.0.0-linux.tar.gz.sha256` from a terminal).
...
```Shell
java -jar dividend-reformulater-2025.0.0.jar
```
